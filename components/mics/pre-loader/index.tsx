    ...
    <AnimatePresence mode="wait">
      {isVisible && (
        <motion.div
          ...
          className="fixed inset-0 z-9999 flex flex-col items-center justify-center bg-background select-none text-primary overflow-hidden w-full h-full pointer-events-auto"
        >
