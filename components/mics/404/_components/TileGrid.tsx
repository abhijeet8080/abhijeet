...
export const TileGrid: React.FC<TileGridProps> = ({
  ...
  return (
    <motion.div
      ...
      className="relative bg-card/80 backdrop-blur-sm border border-border rounded-3xl p-4 xs:p-6 sm:p-8 my-4"
    >
      ...
      <div className="mt-6 flex items-center justify-center gap-3">
        <button
          onClick={onReset}
          className="inline-flex items-center gap-2 rounded-lg border border-border bg-background/60 px-4 py-2 font-mono text-xs font-semibold uppercase tracking-wider text-primary transition-colors hover:border-card-border-hover hover:bg-card-hover cursor-pointer"
        >
          <FaRotateRight className="size-3 text-accent" />
